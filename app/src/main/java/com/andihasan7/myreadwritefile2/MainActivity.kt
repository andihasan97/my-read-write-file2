package com.andihasan7.myreadwritefile2
...
import com.andihasan7.myreadwritefile2.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(view: View) {
        when (view.id) {
            R.id.button_new -> newFile() // methode untuk membuat berkas baru
            R.id.button_open -> showList() // methode untuk membuka & menampilkan berkas
            R.id.button_save -> saveFile() // methode untuk menyimpan berkas
